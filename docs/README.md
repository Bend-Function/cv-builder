...
- **[使用指南](./usage.md)** — 如何编辑简历、切换主题、调整版式、导出 PDF
- **[架构说明](./architecture.md)** — 系统架构、数据流、渲染机制
- **[设计文档](./design.md)** — 设计决策、主题系统、扩展点
- **[开发指南](./development.md)** — 如何修改代码、添加新主题、添加新章节
- **[部署文档](./deployment.md)** — 本地开发、构建、Vercel/服务器部署
- **[JSON 格式参考](./json-schema.md)** — 数据结构的完整说明（英文）
